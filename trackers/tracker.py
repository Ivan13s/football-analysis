...
class Tracker:
    ...
    def interpolate_ball_positions(self,ball_positions):
        ...
        df_ball_positions=df_ball_positions.bfill() # just for the first few frames if there are any missing values
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
       ...
       # Get the number of times each team had ball control
        ...
        if total_frames > 0:
            ...
            team_1 = team_2 = 0  # Or set a default value or behavior in case of zero total frames
